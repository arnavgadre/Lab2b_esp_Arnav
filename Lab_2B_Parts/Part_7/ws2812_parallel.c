...
int main() {
 ...
 \\wsl.localhost\Ubuntu\home\arnavgadre\Git-Repos\Lab2b_esp_Arnav\Lab_2B_Parts\Part_6\build\pio_logic_analyser.uf2           transform_strings(strings, count_of(strings), colors, NUM_PIXELS * 4, brightness);
